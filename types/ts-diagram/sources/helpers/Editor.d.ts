...
export interface IEditorEventHandlersMap {
    ...
    [EditorEvents.beforeEditorOpen]: (id: Id, key: string, subHeaderId?: string) => boolean | void;
    [EditorEvents.afterEditorOpen]: (id: Id, key: string, subHeaderId?: string) => void;
    [EditorEvents.beforeEditorClose]: (id: Id, key: string, subHeaderId?: string) => boolean | void;
    [EditorEvents.afterEditorClose]: (id: Id, key: string, subHeaderId?: string) => void;
    [EditorEvents.beforeEditorEditing]: (value: string, currentValue: string, id: Id, key: string, subHeaderId?: string) => boolean | void;
    [EditorEvents.afterEditorEditing]: (value: string, id: Id, key: string, subHeaderId?: string) => void;
}
...
export interface IEditor {
    data: ShapesCollection;
    events: EventSystem<EditorEvents, IEditorEventHandlersMap>;
    openEditor(id: Id, key?: string, subHeaderId?: string): boolean;
    closeEditor(): boolean;
    isEditable(): boolean;
    destructor(): void;
    render(): VNode;
