...
import { IDefaultEditorConfig, IOrgEditorConfig, IMindmapEditorConfig, IDiagramEditor, DiagramEditorEvents, IDiagramEditorHandlersMap, IEditorConfig, UndoManager } from "../../ts-diagram-editor";
