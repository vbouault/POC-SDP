import { ActionDirection, IBaseCoords, IItemConfig, ISwimlaneConfig } from "../../ts-diagram";
...
export declare class FreeEditor extends BaseDiagramEditor {
    ...
    protected _getGroupOver(item: IDataItem, option: ITargetOption, target?: any): IDataItem;
    ...
    protected _addItem(item: IItemConfig | ISwimlaneConfig): Id;
